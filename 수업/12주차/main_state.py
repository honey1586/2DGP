...
STATE_IN_GAME , STATE_GAME_OVER = range(2) # 0 , 1 대입
...
def collides_distance(a,b):
    ...
    return distance_sq < radius_sum**2     #루트를 쓰지 않고 한쪽의 값에 제곱을 하여 CPU의 연산을 줄일 수 있다.
...
def enter():
    ...
    global font
    font = gfw.font.load('res/ConsolaMalgun.ttf',36)
