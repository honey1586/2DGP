...
>
> - Trigger : 원작 게임은 캐릭터가 맵에 있는 동안 정해진 위치에서 적이 나오거나 일정 위치를 지나가면 적이 등장하기 때문에 트리거 기술이 필요하다.
...
> |         일정          |             개발 내용              |
> | :-------------------: | :--------------------------------: |
> | 1주차 (10.12 ~ 10.19) |             소스 탐색              |
> | 2주차 (10.19 ~ 10.26) |     캐릭터 클래스 설계 및 구현     |
> | 3주차 (10.26 ~ 11.2)  |     Enemy 클래스 설계 및 구현      |
> |  4주차 (11.2 ~ 11.9)  | 캐릭터와 Enemy 오브젝트의 충돌처리 |
> | 5주차 (11.9 ~ 11.16)  |              맵 구현               |
